...
/// @DnDVersion : 1
/// @DnDHash : 360CA3B4
/// @DnDArgument : "var" "distance_to_object(wolf_threat)"
/// @DnDArgument : "op" "1"
/// @DnDArgument : "value" "70"
if(distance_to_object(wolf_threat) < 70){	/// @DnDAction : YoYo Games.Movement.Set_Direction_Point
	/// @DnDVersion : 1
	/// @DnDHash : 56D8ECBC
	/// @DnDParent : 360CA3B4
	/// @DnDArgument : "x" "wolf_threat.x"
	/// @DnDArgument : "y" "wolf_threat.y"
	direction = point_direction(x, y, wolf_threat.x, wolf_threat.y);
